...
public class IjkTrackInfo implements ITrackInfo {
    ...
    //common
    public int getIndex() {
        return mStreamMeta.mIndex;
    }

    public String getCodecType() {
        return mStreamMeta.getCodecShortNameInline();
    }

    public String getBitrateInline() {
        return mStreamMeta.getBitrateInline();
    }
    ...
    public String getResolutionInline() {
        return mStreamMeta.getResolutionInline();
    }

    public String getFpsInline() {
        return mStreamMeta.getFpsInline();
    }

    //audio

    public String getSampleRateInline() {
        return mStreamMeta.getSampleRateInline();
    }

    public String getChannelLayoutInline() {
        return mStreamMeta.getChannelLayoutInline();
    }
